...
// El usuario tendrá un conjunto de valores (números o textos) y deberá consultar si un elemento específico existe en el arreglo. Se debe recorrer manualmente la estructura sin usar métodos avanzados como .includes().
